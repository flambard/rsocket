...
%% API
-export([cancel/2, close_connection/1, lease/3, lease/4, metadata_push/2,
         request_channel/3, request_channel/4, request_fnf/2, request_fnf/3, request_response/3,
         request_response/4, request_stream/3, request_stream/4]).
...
lease(Connection, TimeToLive, NumberOfRequests, Options) ->
    rsocket_connection:send_lease(Connection, TimeToLive, NumberOfRequests, Options).
...
request_response(Connection, Request, Handler, Options) ->
    rsocket_connection:send_request_response(Connection, Request, Handler, Options).
